...
const DashboardView = ({ insights }) => {
  // Transform salary data for the chart - convert to Lakhs for better readability
  ...
  // Format INR amounts properly
  const formatINR = (amountInLakhs) => {
    const amountInRupees = amountInLakhs * 100000; // Convert back to rupees
    
    if (amountInRupees >= 10000000) { // 1 Crore
    ...
    <div className="space-y-6">
      ...
      <Card className="col-span-4">
        <CardHeader>
          ...
          <CardDescription>
            Displaying minimum, median, and maximum salaries (in Lakhs INR per annum)
          </CardDescription>
        </CardHeader>
        <CardContent>
